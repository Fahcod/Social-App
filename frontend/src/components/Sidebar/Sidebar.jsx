  ...
  return (
    ...
    <div className="w-full pt-3 flex flex-col gap-9 pl-6 dark:text-white">
      ...
      <div className="relative flex items-center gap-4 cursor-pointer">
        <BiGroup className='w-7 h-7 text-icon dark:text-white'/>
        <p className='font-rubik text-lg pt-1'>Friends</p>
        <div className="w-3 h-3 bg-green-500 rounded-full absolute top-1 left-0"></div>
      </div>
      
      <div className="flex items-center gap-4 cursor-pointer">
        <FaRegBookmark className='w-6 h-6 text-icon dark:text-white'/>
        <p className='font-rubik text-lg pt-1'>Saved</p>
      </div>

      <Link to="/videos">
      <div className="flex items-center gap-4 cursor-pointer">
        <MdOndemandVideo className='w-7 h-7 text-icon dark:text-white'/>
        <p className='font-rubik text-lg pt-1'>Videos</p>
      </div>
      </Link>
      ...
      <div className="relative flex items-center gap-4 cursor-pointer">
        ...
        <p className='font-rubik text-lg pt-1'>Messaging</p>
      ...
      <div className="flex items-center gap-4 cursor-pointer" onClick={()=>dispatch(showNotify(true))}>
        ...
        <BiBell className='w-7 h-7 text-icon dark:text-white'/>
      ...
      <div className="flex items-center gap-4 cursor-pointer">
        <BiGroup className='w-7 h-7 text-icon dark:text-white'/>
        <p className='font-rubik text-lg pt-1'>Communities</p>
      </div>
      </Link>

      <div className="flex items-center gap-4 cursor-pointer">
        <BiMenu className='w-8 h-8 text-icon dark:text-white'/>
        <p className='font-rubik text-lg pt-1'>More</p>
      </div>
